...
_Esta épica engloba la entrada al sistema, la autenticación y el enrutamiento base dependiendo de los roles._
...
_Gestión del directorio de empleados y sus permisos._
...
_Registro y visualización del historial transaccional de novedades del empleado._
...
_Ciclo completo de solicitud, revisión y control de días de descanso._
...
_Visualización de datos de alto nivel para la toma de decisiones._
...
- **Capa de Datos:** Prisma Client ejecutándose en el entorno de servidor de Next.js, conectándose directamente a la base de datos PostgreSQL alojada en Supabase mediante _connection pooling_.
